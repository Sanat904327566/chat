...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.infobox.hasnat.ume.ume.R.layout.activity_register);
        Log.d(TAG, "on Create : started");

        mAuth = FirebaseAuth.getInstance();
        user = mAuth.getCurrentUser();

        registerUserFullName = (EditText)findViewById(com.infobox.hasnat.ume.ume.R.id.registerFullName);
        registerUserEmail = (EditText)findViewById(com.infobox.hasnat.ume.ume.R.id.registerEmail);
        registerUserMobileNo = (EditText)findViewById(com.infobox.hasnat.ume.ume.R.id.registerMobileNo);
        registerUserPassword = (EditText)findViewById(com.infobox.hasnat.ume.ume.R.id.registerPassword);
        confirmRegisterUserPassword = (EditText)findViewById(com.infobox.hasnat.ume.ume.R.id.confirm_registerPassword);

        //Working with Create A/C Button Or, Register a/c
        registerUserButton = (Button) findViewById(com.infobox.hasnat.ume.ume.R.id.resisterButton);
